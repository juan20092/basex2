...
console.log(`╭──» 𝙀𝙇𝙄𝙏𝙀 𝘽𝙊𝙏 𝙂𝙇𝙊𝘽𝘼𝙇 «───
┊ ${chalk.blue(me + ' ~' + conn.user.name + (conn.user.jid == global.conn.user.jid ? '' : ' (𝗚𝗕 - 𝗦𝗨𝗕 𝗕𝗢𝗧)'))} ${chalk.black(chalk.cyan(m.messageStubType ? WAMessageStubType[m.messageStubType] : ''))}

...
// Variables para comandos ocultos (no modificar)
...
let handler = async (m, { conn, args, usedPrefix, command, isOwner }) => {
    ...
    // Usar la variable jadi correctamente definida
    let pathDuckJadiBot = path.join(__dirname, '..', jadi, id)
...
// ===== FUNCIÓN DE REINICIO DE SUB-BOTS =====
async function checkSubBots() {
    // Usar la misma variable jadi definida al principio
    const subBotDir = path.resolve(__dirname, '..', jadi);
...
// Configurar el intervalo para ejecutar la función de reinicio cada 10 minutos
